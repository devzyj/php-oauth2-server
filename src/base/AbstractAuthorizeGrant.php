 ...
 */
namespace devzyj\oauth2\server\base;
...
use devzyj\oauth2\server\exceptions\UnauthorizedClientException;
use devzyj\oauth2\server\exceptions\ForbiddenException;
use devzyj\oauth2\server\exceptions\InvalidScopeException;
use devzyj\oauth2\server\exceptions\UniqueIdentifierException;
use devzyj\oauth2\server\exceptions\ServerErrorException;
